...
@section('title')
	Tu solicitud de baja se ha procesado con éxito.
@stop
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="bodycopy">
                  	Recuerda que siempre puedes volver a inscribirte y apuntarte a nuestras ofertas/promociones. Esperamos verte pronto por aquí.
                </td>
              </tr>
              <tr>
